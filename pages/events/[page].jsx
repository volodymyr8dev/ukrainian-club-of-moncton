...
function Events({ currentPageNumber, hasNextPage, hasPreviousPage, posts }) {
  ...
  return (
    <>
      <Head>
        <title>Events - Ukrainian Association of Moncton</title>
        {/* equal data */}
          ...
          <div className="info-section-bg">
            ...
            <section className="flex justify-center mb-16 md:mb-28 pl-6 md:px-6">
              <div className="flex justify-center flex-col max-w-[1215px] w-full">
                <div
                  className="flex justify-between gap-2 xl:gap-0 -ml-[23px]
              md:ml-0"
                >
                  <MobileSwiperDisplay posts={posts} />
                  <div
                    className="justify-start gap-2 xl:gap-8 max-w-full
                    ...
                    {posts.map((post, i) => {
                      return isPostInvalid(router.locale, post.node) ? (
                        ...
                        >
                          ...
                          <div
                            className="px-4 lg:px-6 pt-6 flex flex-col
                          ...
                          >
                            ...
                            <div>
                              ...
                              >
                                ...
                                >
                                  {moment(post.node.createdAt).format(
                                    "MMM DD, YYYY"
                                  )}
                                </span>
                                ...
                                <Link href={`/posts/${post.node.slug}`}>
                                  <span
                                    className="bg-[#006DB6] text-gray-100
                ...
                >
                  ...
                  >
                    {hasPreviousPage ? (
                      <Link href={`${currentPageNumber - 1}`} scroll={false}>
                        <span>
                          <Image
                            src={previousBlue}
                            alt="previous"
                      ...
                      <Image src={previousGray} alt="" />
                    )}

                    <Image src={lineGray} alt="" />
