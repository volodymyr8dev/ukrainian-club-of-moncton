...
export const HomeFront = () => {
  ...
  return (
    <>
    <section
      className='home-front-section min-h-[calc(110vh-5rem)] flex justify-center items-center mb-[112px]
    ...
    >
      ...
      w-full tablets:w-auto'>
        ...
        hidden md:flex flex-col gap-8 mt-0 md:mt-[14.4rem]'>
          ...
          > */}
            <h2
              className="font-proximaNova300 text-[34px] md:text-[50px]
          leading-[40px] md:leading-[65px] first-letter:tracking-wide"
            >
              {data[32].textContent}
              <br />
              <span
                className="font-proximaNova500 text-blue-500 text-[43px] 
                md:text-[62.81px]"
              >
                {data[33].textContent}
              </span>{" "}
              <span
                className="font-proximaNova500 text-yellow-300 text-[43px] 
                md:text-[62.81px]"
              >
                {data[34].textContent}
              </span>
