  ...
  return (
    ...
    >
      ...
      w-full tablets:w-auto'>
        <div className='lg:max-w-[340px] max-w-[280px] 2xl:max-w-[540px] flex
        flex-col gap-6 md:gap-8 lg:-mt-8 mt-12 tablets:-mt-8'>
        ...
        hidden tablets:flex flex-col gap-8 mt-0 md:mt-[14.4rem]'>
        ...
        <div className='max-w-full flex tablets:hidden flex-col gap-6 mt-2
        tablets:mt-20'>
